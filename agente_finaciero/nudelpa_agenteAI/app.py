...
def reiniciarChat():
    ...
    if "messages" in st.session_state:
        ...
        promtpSistema = " Eres un analista financiero. Puedes hacer un análisis de los datos y ofrecer recomendaciones, dando siempre respuestas claras y concretas y siempre en idioma español, si te piden tablas o listas, las generas siempre en markdown"
...
st.header('Agente IA grok Analista Finaciero.')
